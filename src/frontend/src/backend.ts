...
import type { LeadSubmission as _LeadSubmission } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getMyLeads(): Promise<Array<LeadSubmission>> {
        if (this.processError) {
            try {
    ...
    async submitLead(arg0: string, arg1: string, arg2: string, arg3: string | null, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitLead(arg0, arg1, arg2, to_candid_opt_n5(this._uploadFile, this._downloadFile, arg3), arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_LeadSubmission_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _LeadSubmission): LeadSubmission {
...
function from_candid_vec_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_LeadSubmission>): Array<LeadSubmission> {
    return value.map((x)=>from_candid_LeadSubmission_n2(_uploadFile, _downloadFile, x));
}
